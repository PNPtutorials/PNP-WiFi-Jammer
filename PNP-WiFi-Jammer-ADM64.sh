...
wget http://ftp.tudelft.nl/security.debian.org/pool/updates/main/libn/libnl/libnl1_1.1-7+deb7u1_amd64.deb
dpkg -i  libnl1_1.1-7+deb7u1_amd64.deb
wget http://ftp.tudelft.nl/security.debian.org/pool/updates/main/libn/libnl/libnl-dev_1.1-7+deb7u1_amd64.deb
