...
sudo apt-get install libpcap-dev python-dev gcc g++ make git subversion libssl-dev libpcap-dev libpcre3-dev libsqlite3-dev pkg-config python-dev
...
then
	...
	sudo dpkg -i libnl-dev_1.1-7+deb7u1_i386.de
	sudo rm libnl1_1.1-7+deb7u1_i386.deb
	sudo rm libnl-dev_1.1-7+deb7u1_i386.de
...
#pip install urllib
sudo wget "https://drive.google.com/uc?export=download&id=0ByKtlN4NOMLeV0JfbTU1YUo0Qmc"
sudo mv "uc?export=download&id=0ByKtlN4NOMLeV0JfbTU1YUo0Qmc" "install.py"
