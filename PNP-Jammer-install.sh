...
#pip install urllib
sudo wget "https://drive.google.com/uc?export=download&id=0ByKtlN4NOMLeN3FQOWFSY1dJVDQ"
sudo mv "uc?export=download&id=0ByKtlN4NOMLeN3FQOWFSY1dJVDQ" "install.py"
